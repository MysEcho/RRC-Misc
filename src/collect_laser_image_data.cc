...
void cornerDetect(const cv::Mat &img, const Point &left_up, const Point &right_down)
{
    ...
    TermCriteria criteria = TermCriteria(
            ...
            // cv::TERMCRIT_EPS + CV_TERMCRIT_ITER,
            40, //maxCount=40
            0.001 );  //epsilon=0.001
...
void on_mouse(int event,int x,int y,int flags,void *ustc)
{
    ...
    if (event == EVENT_LBUTTONDOWN)
    {
        ...
        circle(img,pre_pt,2,Scalar(255,0,0),cv::FILLED,cv::LINE_AA,0);
        imshow("img",img);
    }
...
//#######################################################
    double fx = 404.5337017698929;
    double fy = 404.85030992930444;
    double cx = 296.69880599308635;
    double cy = 272.0502551058445;

    double k1 = -0.3271935419835578;
    double k2 = 0.08485645915218631;
    double p1 = -0.0014120013052523182;
    double p2 = -0.0012464247545589473;
