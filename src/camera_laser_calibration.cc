...
int main(int argc, char* argv[])
{
    ...
    Config::setParameterFile("home/cam_ws/src/camera_lidar_calibration_v2/config/config.yaml");
...
bool LoadData(const string &data_path, Vector3dPoints &laser_points, Vector2dPoints &image_points)
{
    ...
    while (in_file >> value1 >> value2 >> value3 >> value4) {
        laser_point(0)=value1;
        laser_point(1)=value2;
        image_point(0)=value3;
        image_point(1)=value4;
        laser_point(2)=0;
...
//CHECK FOR CHANGE (Check LocalParameterization -> Manifold )
//#############################################################################
void BuildOptimizationProblem(Vector3dPoints &laser_points,
                              const Vector2dPoints &image_points,
                              Quaterniond &q,
